<template>
  <q-page class="flex justify-center">
    <div class="q-pa-md first-div" >
      ...
      <div class="q-mt-sm">
       <q-input type="file" accept=".pdf" @change="handlePdfUpload" style="display: none;" ref="pdfInput" />
      ...
      <div  class="q-mt-xl flex justify-between" style="width:100%" v-if="qrCodeDataUrl&&this.addFrame  && !showLoader">
         ...
         <div class=" q-mt-md flex justify-between " style="width:100%" v-if="qrCodeDataUrl&&this.addFrame  && !showLoader">
    ...
    for (let row = 0; row < numCells; row++) {
      for (let col = 0; col < numCells; col++) {
       ...
       if(!this.selectedImageFramePath){
        console.log('selectttttpath :', this.selectedImageFramePath)

       }
    if (this.selectedImageFramePath ||(this.selectedImageFramePath && this.overlayDrawImage)) {
      console.log("selectedPath :", this.selectedImageFramePath);
